...
$.getJSON("https://www2c.cdc.gov/podcasts/feed.asp?feedid=198&maxnumber=0&pagesize=9999&daterange=2&startdate=1/1/17&enddate=12/31/17&format=json&callback=?",
                function (data) {
                                var count_items = 0;
                                var list = $('<ul />');
                                 $('#rss-featurefeed-images-diseasesconditions2017').append(list);
