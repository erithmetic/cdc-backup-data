...
DATA DATAOUT.CDBRFS92;
   LENGTH DEFAULT=4;
   LENGTH _WTFORHT _FRTSERV 6 _DRNKMO 5 _GRAMFAT 7
          _POSTSTR _FINALWT 8;
   INFILE DATAIN;

* CREATE RISK FACTOR SAS FILE FOR 1992 SURVEILLANCE DATA;
...
LABEL HOWLONG = HOW LONG SINCE LAST MAMMOGRAM
 /*         1 = '1 YEAR AGO OR LESS'
            2 = '>1 YEAR, BUT <=2 YEARS AGO'
            3 = '>2 YEARS, BUT <=3 YEARS AGO'
            4 = '>3 YEARS, BUT <=5 YEARS AGO'
            5 = '>5 YEARS AGO'
            7 = 'DO NOT KNOW'
            8 = 'NEVER'
            9 = 'REFUSED' */;
...
LABEL   POISON = PHONE NO. TO POISON CONTROL CENTER
 /*          1 = 'YES'
             2 = 'NO'
             7 = 'DO NOT KNOW'
             9 = 'REFUSED' */;
