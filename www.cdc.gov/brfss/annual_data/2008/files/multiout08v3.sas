...
*****************************************************************************
* EXAMPLE:                                                                  *
*       FILENAME DATAIN 'C:\BRFSS\2008\BRFS08V3.ASC' LRECL =         1294           *
...
_POSTCH3 = 'POST-STRATIFICATION CHILD WEIGHT QUESTIONNAIRE VERSION 3 (POPULATION ESTIMATE FOR AGE/GENDER/RACE CATEGORIES DIVIDED BY THE WEIGHTED SAMPLE FREQUENCY
BY AGE/RACE/GENDER).'
_POSTQ3 = 'POST-STRATIFICATION WEIGHT QUESTIONNAIRE VERSION 3 (POPULATION ESTIMATE FOR AGE/GENDER/RACE CATEGORIES DIVIDED BY THE WEIGHTED SAMPLE FREQUENCY BY AGE/
RACE/GENDER).'
