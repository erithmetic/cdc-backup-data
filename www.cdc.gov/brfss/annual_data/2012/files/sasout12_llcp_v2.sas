*****************************************************************************************
* FILE NAME:     SASOUT12_LLCP_V2.SAS                                                   *
...
*****************************************************************************
* EXAMPLE:                                                                  *
*       FILENAME DATAIN 'C:\BRFSS\2012\LLCP12V2.ASC' LRECL = 1682           *
...
CHILDAGE      1162-1164
_CLCM5V1      1290-1292
_CLCM1V2      1303-1305               /* Child Weighting Variables */
_CLCM2V2      1306-1308
_CLCM3V2      1309-1311
_CLCM4V2      1312-1314
_CLCM5V2      1315-1317
...
_CLCM1V2 = 'VERSION 2 CHILD COMBINED LAND-LINE AND CELL-PHONE FIRST MARGIN (AGE-GENDER)'
_CLCM2V2 = 'VERSION 2 CHILD COMBINED LAND-LINE AND CELL-PHONE SECOND MARGIN (RACE/ETHNICITY)'
_CLCM3V2 = 'VERSION 2 CHILD COMBINED LAND-LINE AND CELL-PHONE THIRD MARGIN (GENDER-RACE/ETHNICITY)'
_CLCM4V2 = 'VERSION 2 CHILD COMBINED LAND-LINE AND CELL-PHONE FOURTH MARGIN (AGE-RACE/ETHNICITY)'
...
_CLCWTV2 = 'VERSION 2  CHILD WEIGHT: LAND-LINE AND CELL-PHONE DATA'
...
_LCM01V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE FIRST MARGIN (AGE-GENDER)'
_LCM02V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE SECOND MARGIN (RACE/ETHNICITY)'
_LCM03V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE THIRD MARGIN (EDUCATION)'
_LCM04V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE FOURTH MARGIN (MARITAL STATUS)'
_LCM05V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE FIFTH MARGIN (HOME OWNERSHIP)'
_LCM06V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE SIXTH MARGIN (GENDER-RACE/ETHNICITY)'
_LCM07V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE SEVENTH MARGIN (AGE-RACE/ETHNICITY)'
_LCM08V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE EIGHTH MARGIN (TELEPHONE SOURCE)'
_LCM09V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE NINTH MARGIN (REGIONS)'
_LCM10V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE TENTH MARGIN (REGIONS-AGE)'
_LCM11V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE ELEVENTH MARGIN (REGIONS-GENDER)'
_LCM12V2 = 'VERSION 2 COMBINED LAND-LINE AND CELL-PHONE TWELFTH MARGIN (REGIONS-RACE/ETHNICITY)'
_LCPWTV2 = 'VERSION 2 WEIGHT: LAND-LINE AND CELL-PHONE DATA'
