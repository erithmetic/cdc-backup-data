*****************************************************************************************
* FILE NAME:     SASOUT12_LLCP_V1.SAS                                                   *
...
*****************************************************************************
* EXAMPLE:                                                                  *
*       FILENAME DATAIN 'C:\BRFSS\2012\LLCP12V1.ASC' LRECL = 1682           *
...
_WT2CH        1152-1161
CHILDAGE      1162-1164
_CLCM1V1      1278-1280               /* Child Weighting Variables */
_CLCM2V1      1281-1283
_CLCM3V1      1284-1286
_CLCM4V1      1287-1289
_CLCM5V1      1290-1292
...
_CLCM1V1 = 'VERSION 1 CHILD COMBINED LAND-LINE AND CELL-PHONE FIRST MARGIN (AGE-GENDER)'
_CLCM2V1 = 'VERSION 1 CHILD COMBINED LAND-LINE AND CELL-PHONE SECOND MARGIN (RACE/ETHNICITY)'
_CLCM3V1 = 'VERSION 1 CHILD COMBINED LAND-LINE AND CELL-PHONE THIRD MARGIN (GENDER-RACE/ETHNICITY)'
_CLCM4V1 = 'VERSION 1 CHILD COMBINED LAND-LINE AND CELL-PHONE FOURTH MARGIN (AGE-RACE/ETHNICITY)'
...
_LCM01V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE FIRST MARGIN (AGE-GENDER)'
_LCM02V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE SECOND MARGIN (RACE/ETHNICITY)'
_LCM03V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE THIRD MARGIN (EDUCATION)'
_LCM04V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE FOURTH MARGIN (MARITAL STATUS)'
_LCM05V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE FIFTH MARGIN (HOME OWNERSHIP)'
_LCM06V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE SIXTH MARGIN (GENDER-RACE/ETHNICITY)'
_LCM07V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE SEVENTH MARGIN (AGE-RACE/ETHNICITY)'
_LCM08V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE EIGHTH MARGIN (TELEPHONE SOURCE)'
_LCM09V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE NINTH MARGIN (REGIONS)'
_LCM10V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE TENTH MARGIN (REGIONS-AGE)'
_LCM11V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE ELEVENTH MARGIN (REGIONS-GENDER)'
_LCM12V1 = 'VERSION 1 COMBINED LAND-LINE AND CELL-PHONE TWELFTH MARGIN (REGIONS-RACE/ETHNICITY)'
