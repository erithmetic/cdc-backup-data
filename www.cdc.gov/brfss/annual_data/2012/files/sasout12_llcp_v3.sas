*****************************************************************************************
* FILE NAME:     SASOUT12_LLCP_V3.SAS                                                   *
...
*****************************************************************************
* EXAMPLE:                                                                  *
*       FILENAME DATAIN 'C:\BRFSS\2012\LLCP12V3.ASC' LRECL = 1682           *
...
_CLCM5V1      1290-1292
_CLCM5V2      1315-1317
_CLCM1V3      1328-1330               /* Child Weighting Variables */
_CLCM2V3      1331-1333
_CLCM3V3      1334-1336
_CLCM4V3      1337-1339
_CLCM5V3      1340-1342
...
_CLCM1V3 = 'VERSION 3 CHILD COMBINED LAND-LINE AND CELL-PHONE FIRST MARGIN (AGE-GENDER)'
_CLCM2V3 = 'VERSION 3 CHILD COMBINED LAND-LINE AND CELL-PHONE SECOND MARGIN (RACE/ETHNICITY)'
_CLCM3V3 = 'VERSION 3 CHILD COMBINED LAND-LINE AND CELL-PHONE THIRD MARGIN (GENDER-RACE/ETHNICITY)'
_CLCM4V3 = 'VERSION 3 CHILD COMBINED LAND-LINE AND CELL-PHONE FOURTH MARGIN (AGE-RACE/ETHNICITY)'
_CLCM5V1 = 'VERSION 1 CHILD COMBINED LAND-LINE AND CELL-PHONE FIFTH MARGIN (TELEPHONE SOURCE)'
_CLCM5V2 = 'VERSION 2 CHILD COMBINED LAND-LINE AND CELL-PHONE FIFTH MARGIN (TELEPHONE SOURCE)'
_CLCM5V3 = 'VERSION 3 CHILD COMBINED LAND-LINE AND CELL-PHONE FIFTH MARGIN (TELEPHONE SOURCE)'
_CLCWTV3 = 'VERSION 3  CHILD WEIGHT: LAND-LINE AND CELL-PHONE DATA'
...
_LCM01V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE FIRST MARGIN (AGE-GENDER)'
_LCM02V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE SECOND MARGIN (RACE/ETHNICITY)'
_LCM03V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE THIRD MARGIN (EDUCATION)'
_LCM04V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE FOURTH MARGIN (MARITAL STATUS)'
_LCM05V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE FIFTH MARGIN (HOME OWNERSHIP)'
_LCM06V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE SIXTH MARGIN (GENDER-RACE/ETHNICITY)'
_LCM07V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE SEVENTH MARGIN (AGE-RACE/ETHNICITY)'
_LCM08V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE EIGHTH MARGIN (TELEPHONE SOURCE)'
_LCM09V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE NINTH MARGIN (REGIONS)'
_LCM10V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE TENTH MARGIN (REGIONS-AGE)'
_LCM11V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE ELEVENTH MARGIN (REGIONS-GENDER)'
_LCM12V3 = 'VERSION 3 COMBINED LAND-LINE AND CELL-PHONE TWELFTH MARGIN (REGIONS-RACE/ETHNICITY)'
_LCPWTV3 = 'VERSION 3 WEIGHT: LAND-LINE AND CELL-PHONE DATA'
